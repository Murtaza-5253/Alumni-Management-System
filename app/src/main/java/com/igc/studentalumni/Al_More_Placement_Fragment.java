...
public class Al_More_Placement_Fragment extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.al_more_placements);
        init();
            ...
            FirebaseStorage.getInstance().getReference().child(cyProfile).getDownloadUrl()
                    .addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            bundleuris=uri;
                            Glide.with(Al_More_Placement_Fragment.this).load(bundleuris).into(imgCompanyProfile);
                            image=true;
                        }
                    });
    ...
    {
        hud = KProgressHUD.create(Al_More_Placement_Fragment.this)
